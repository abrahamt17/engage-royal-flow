...
const ApiDocs = () => {
  ...
  const endpoints = [
    { method: "GET", path: "/campaigns", desc: "List all campaigns", params: "limit, offset" },
    { method: "GET", path: "/campaigns/:id", desc: "Get campaign by ID", params: "—" },
    { method: "GET", path: "/creators", desc: "List creators (filterable)", params: "limit, offset, category, platform, min_engagement" },
    { method: "GET", path: "/creators/:id", desc: "Get creator by ID", params: "—" },
    { method: "GET", path: "/payroll", desc: "List payroll entries", params: "limit, offset" },
    { method: "GET", path: "/analytics", desc: "Get analytics summary", params: "—" },
    { method: "GET", path: "/fraud", desc: "Get fraud risk data", params: "limit, offset" },
    { method: "GET", path: "/benchmarks", desc: "Get industry benchmarks", params: "limit, offset" },
  ];
...
console.log(data);`;
  ...
  return (
    <DashboardLayout title="API Documentation" subtitle="REST API for external platform integrations">
      {/* Overview */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-xs">Bearer token via <code className="bg-muted px-1 rounded">Authorization</code> header</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
